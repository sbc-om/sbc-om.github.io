---
title: Senior Blockchain docs
head:
  - tag: title
    content: Senior Blockchain docs
...
hero:
  ...
  image:
      alt: A Senior Blockchain's Logo
  ...
  actions:
    ...
    - text: View on GitHub
      icon: external
      link: https://github.com/sbc-om/sbc-om.github.io
---
...
<CardGrid stagger>
  ...
  <Card title="Outils et Équipements" icon="seti:eslint">
    Découvrez la gamme complète d'outils et d'équipements de qualité supérieure de Senior Blockchain. Chaque sous-section offre des spécifications détaillées, des instructions d'utilisation et des conseils de maintenance.
  </Card>
